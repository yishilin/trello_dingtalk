let action = {
    ...
    data: {
        ...
        idMember: '5949c3408602f237c1611a36'
    },
    type: 'addMemberToCard',
    date: '2017-09-22T06:38:03.475Z',
    member: {
...
module.exports = {
    "msgtype": "markdown",
    "markdown": {
        "title": "{{action.memberCreator.fullName}} 添加卡片负责人",
        "text": "#### {{action.memberCreator.fullName}} ({{action.memberCreator.username}}) 给卡片 [#{{action.data.card.idShort}} {{action.data.card.name}}](https://trello.com/c/{{action.data.card.shortLink}}) 添加负责人：\n" +
